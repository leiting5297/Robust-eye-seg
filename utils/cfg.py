...
def parse_args():    
    ...
    parser.add_argument('-net', type=str, required=False, help='net type',default='sam')
    ...
    parser.add_argument('-mod', type=str, required=False, help='mod type:seg,cls,val_ad',default='sam')
    parser.add_argument('-exp_name', type=str, required=False, help='net type',default='*msa_test_isic*')
